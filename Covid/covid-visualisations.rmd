...
1. I want to go on holiday in Europe but want the best chance of avoiding
Covid. Which European countries should I consider and which ones should I
avoid?
...
typed_data %>%
  ...
  geom_col(
    mapping = aes(
      x=reorder(location, desc(total_cases)),
      y=total_cases,
      fill=total_cases,
    ),
  ) +
  scale_y_continuous(labels = unit_fmt_billions) +
  scale_fill_gradient(low = "blue", high = "red") +
  apply_project_theme() +
  theme(
    axis.text.x = element_text(angle = 70, hjust=1),
    panel.grid.major.y = minor_element_line,
  ) +
  labs(
    title="Cumulative Covid cases in Europe where total > 100 Million",
    x="Countries",
    y="Total cases (Billions)",
  )

# TODO: Use integer on Y axis
# TODO: Put countries above their bar

save_plot("cumulative-european-covid-cases.jpeg")
```
